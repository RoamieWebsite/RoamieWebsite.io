// Defining quiz questions and possible results
const questions = [
    ...
    { question: "What's your travel budgeting style?", options: ["Save up for a big trip and splurge", "Plan meticulously to get the best deals", "Budget carefully and stick to it", " Spend on experiences rather than material things"] },
    { question: "What's your favorite part of traveling?", options: ["Trying new foods and cuisines", "Meeting new people and making friends", "Exploring nature and outdoor activities", " Learning about different cultures and histories"] },
    { question: "What motivates you to travel?", options: ["Learning about different cultures and histories", "Escaping the routine and relaxing", "Seeking adrenaline-filled adventures", " Connecting with people from around the world"] },
